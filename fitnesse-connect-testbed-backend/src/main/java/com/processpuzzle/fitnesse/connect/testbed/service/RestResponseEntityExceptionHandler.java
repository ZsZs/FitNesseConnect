...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   @ExceptionHandler( value = { CarNotFoundException.class } ) protected ResponseEntity<Object> handleCarNotFound( RuntimeException ex, WebRequest request ) {
      String bodyOfResponse = "Car not found.";
