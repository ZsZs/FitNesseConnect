...
public class DeleteRestResource extends RestConnector {
   private static final Logger logger = LoggerFactory.getLogger( DeleteRestResource.class );

   // constructors
   public DeleteRestResource( String configurationName, String resourcePath ) {
