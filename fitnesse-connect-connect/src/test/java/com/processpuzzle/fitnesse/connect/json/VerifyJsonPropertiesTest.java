...
/*   
   @Test public void verifyColumn_whenDataTypeMatches_returnsPass(){
      verifyJson.setProperty( "String Column" );
      verifyJson.setDataType( "String" );
      assertThat( verifyJson.verifyProperty(), equalTo( "pass" ));
      
      verifyJson.setColumn( "Integer Column" );
      verifyJson.setDataType( "Integer" );
      assertThat( verifyJson.verifyProperty(), equalTo( "pass" ));
      
      verifyJson.setColumn( "Date Column" );
      verifyJson.setDataType( "Date" );
      assertThat( verifyJson.verifyProperty(), equalTo( "pass" ));
   }
   
   @Test public void verifyColumn_whenColumnIsMandatory_returnsPass(){
      verifyJson.setColumn( "Optional Column" );
      verifyJson.setDataType( "String" );
      verifyJson.setIsMandatory( "no" );
      verifyJson.setIsValueMandatory( "yes" );
      assertThat( verifyJson.verifyProperty(), equalTo( "pass" ));
   }
   
   @Test public void verifyColumn_whenColumnValueIsMandatory_returnsPass(){
      verifyJson.setColumn( "Optional Value Column" );
      verifyJson.setDataType( "String" );
      verifyJson.setIsMandatory( "yes" );
      verifyJson.setIsValueMandatory( "no" );
      assertThat( verifyJson.verifyColumn(), equalTo( "pass" ));
   }
*/
}
